...
function insertNote() {
      ...
      $.ajax({
           type: "POST",
           url: "insertNote.php",
           data: "NOTE_TITLE="+TitleNote+"&Type="+Type+"&NOTE_DETAILTINY="+NOTE_DETAILTINY+"&NOTE_DETAIL="+NOTE_DETAIL,
...
<body style = 'background:#F9F9F9' >
    ...
    <div class="container">
		...
		<div class = 'form-group row' >
			<div class = 'col-sm-4' >
				<input type = 'text' id = 'NOTE_TITLE'  class = 'form-control' placeholder = 'หัวข้อ'  required>
			</div>
			<div class = 'col-sm-8' >
				<input type = 'text' id = 'NOTE_DETAILTINY' class = 'form-control' placeholder = 'รายละเอียดย่อย' maxlength = '120' required >
			</div>
		</div >
		<div class = 'form-group row' >
			<div class = 'col-sm-4' >
			...
			<div class = 'col-sm-8' >
			<input type = 'text' class = 'form-control' placeholder = 'รายละเอียดย่อย' value = '<?php echo date("d/m/Y h:i") ?>' disabled >
			</div>
		</div >
		<p><textarea  id= 'NOTE_DETAIL' class = 'form-control' style = 'width : -webkit-fill-available; height : 58vh' placeholder = "อธิบายเกี่ยวกับโน็ตของคุณ.........." ></textarea> </p>
